...
routes.get("/usuario", JwtMiddle, UserController.getUserProfile);
routes.get("/usuarios", JwtMiddle, UserController.listar);
routes.put("/usuario", JwtMiddle, UserController.atualizar);
...
routes.post(
  ...
  JwtMiddle,
  CartItemController.adicionarAoCarrinho
);

routes.delete(
  "/excluir_do_carrinho",
  JwtMiddle,
  CartItemController.excluirItem
);

routes.get("/meus_itens_carrinho", JwtMiddle, CartItemController.meusItens);

routes.get("/fechar_carrinho", JwtMiddle, CheckoutController.fecharCarrinho);
