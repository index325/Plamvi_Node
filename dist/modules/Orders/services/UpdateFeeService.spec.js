...
var UpdateFeeService_1 = __importDefault(require("./UpdateFeeService"));
var fakeOrdersRepository;
var updateFeeService;
describe('UpdateFee', function () {
    beforeEach(function () {
        fakeOrdersRepository = new FakeOrdersRepository_1.default();
        updateFeeService = new UpdateFeeService_1.default(fakeOrdersRepository);
    });
    it('should be able to update an order fee', function () { return __awaiter(void 0, void 0, void 0, function () {
        var order, updatedOrder;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeOrdersRepository.create({
                        total: 0,
                    })];
                case 1:
                    order = _a.sent();
                    return [4 /*yield*/, updateFeeService.execute({
                            daysToDeliver: 3,
                            fee: 300,
                            order_id: order.id,
                        })];
