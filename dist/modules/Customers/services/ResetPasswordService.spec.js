...
var resetPassword;
describe("CustomerResetPasswordService", function () {
    beforeEach(function () {
        ...
        resetPassword = new ResetPasswordService_1.default(fakeCustomersRepository, fakeCustomerTokensRepository, fakeHashProvider);
    });
    it("should be able to reset the password", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeCustomersRepository.create({
                        name: "John Doe",
                ...
                case 1:
                    user = _a.sent();
                    return [4 /*yield*/, fakeCustomerTokensRepository.generate(user.id)];
                case 2:
                    token = (_a.sent()).token;
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, fakeCustomersRepository.findById(user.id)];
                case 4:
                    updatedUser = _a.sent();
    ...
    it("shoud not be able to reset the password with non-existing token", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it("shoud not be able to reset the password with non-existing user", function () { return __awaiter(void 0, void 0, void 0, function () {
        var token;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeCustomerTokensRepository.generate("non-existing-user")];
                case 1:
                    token = (_a.sent()).token;
    ...
    it("shoud not be able to reset the password if passed more than 2 hours", function () { return __awaiter(void 0, void 0, void 0, function () {
        var user, token;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeCustomersRepository.create({
