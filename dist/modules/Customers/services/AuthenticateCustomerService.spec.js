...
var AuthenticateCustomerService_1 = __importDefault(require("./AuthenticateCustomerService"));
...
describe("CreateCustomer", function () {
    beforeEach(function () {
        ...
        authenticateCustomer = new AuthenticateCustomerService_1.default(fakeCustomersRepository, fakeHashProvider);
    });
    it("should be able to authenticate a customer", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    customer = _a.sent();
                    return [4 /*yield*/, authenticateCustomer.execute({
    ...
    it("should not be able to authenticate user with wrong email", function () { return __awaiter(void 0, void 0, void 0, function () {
        var customer;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createCustomer.execute({
    ...
    it("should not be able to authenticate user with wrong password", function () { return __awaiter(void 0, void 0, void 0, function () {
        var customer;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createCustomer.execute({
