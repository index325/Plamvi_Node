...
var UpdateUserAvatarService = /** @class */ (function () {
    ...
    UpdateUserAvatarService.prototype.execute = function (_a) {
        var avatar = _a.avatar, user_id = _a.user_id;
        return __awaiter(this, void 0, void 0, function () {
            var user, urlAvatar, userUpdated;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.usersRepository.findById(user_id)];
                    case 1:
                        user = _b.sent();
                        return [4 /*yield*/, this.storageProvider.saveFile(avatar)];
                    case 2:
                        urlAvatar = _b.sent();
                        if (!user) {
                            throw new AppError_1.default("Usuário não localizado");
                        }
                        return [4 /*yield*/, this.usersRepository.updateUserAvatar({
                                user: user,
                                avatar: urlAvatar,
                            })];
                    case 3:
