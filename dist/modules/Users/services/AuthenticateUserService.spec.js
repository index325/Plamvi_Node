...
describe('CreateUserService', function () {
    beforeEach(function () {
        usersRepository = new FakeUsersRepository_1.default();
        hashProvider = new FakeHashProvider_1.default();
        authenticateUser = new AuthenticateUserService_1.default(usersRepository, hashProvider);
    });
    it('should be able to create a new user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user, auth;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, usersRepository.create({
                        name: 'John Doe',
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, expect(authenticateUser.execute(nonRegisteredData)).rejects.toBeInstanceOf(AppError_1.default)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
