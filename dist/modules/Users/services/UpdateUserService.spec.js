...
var updateUser;
describe('UpdateUserProfileService', function () {
    beforeEach(function () {
        fakeUsersRepository = new FakeUsersRepository_1.default();
        fakeHashProvider = new FakeHashProvider_1.default();
        updateUser = new UpdateUserService_1.default(fakeUsersRepository, fakeHashProvider);
    });
    it('should be able to update an user data', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('should not be able to update profile from non-existing user', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(updateUser.execute({
    ...
    it("should not be able to change to another user's email", function () { return __awaiter(void 0, void 0, void 0, function () {
        var johnTre;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUsersRepository.create({
                ...
                case 2:
                    johnTre = _a.sent();
                    return [4 /*yield*/, expect(updateUser.execute({
                            user_id: johnTre.id,
                            name: 'John Tre',
                            email: 'johndoe@email.com',
                            password: '123456',
