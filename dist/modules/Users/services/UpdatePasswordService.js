...
var UpdateUserService = /** @class */ (function () {
    ...
    UpdateUserService.prototype.execute = function (_a) {
        var oldPassword = _a.oldPassword, newPassword = _a.newPassword, user_id = _a.user_id;
        return __awaiter(this, void 0, void 0, function () {
            var user, passwordMatched, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        if (!passwordMatched) {
                            throw new AppError_1.default("A senha atual está incorreta");
                        }
                        _b = user;
                        return [4 /*yield*/, this.hashProvider.generateHash(newPassword)];
                    case 3:
                        _b.password = _c.sent();
