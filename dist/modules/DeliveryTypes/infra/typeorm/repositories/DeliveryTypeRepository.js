...
var DeliveryTypeRepository = /** @class */ (function () {
    function DeliveryTypeRepository() {
        this.ormRepository = typeorm_1.getRepository(DeliveryType_1.default);
    }
    DeliveryTypeRepository.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var deliveryType;
            return __generator(this, function (_a) {
                deliveryType = this.ormRepository.create(data);
                return [2 /*return*/, this.ormRepository.save(deliveryType)];
            });
        });
    };
