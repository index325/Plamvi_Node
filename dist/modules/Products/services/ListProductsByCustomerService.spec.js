...
var ListProductsByCustomerService_1 = __importDefault(require("./ListProductsByCustomerService"));
describe("ListProductsByCustomer", function () {
    it("should be able to list products by customer", function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeProductsRepository, fakeStorageProvider, createProduct, listProductsByCustomer, product, foundProduct;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    listProductsByCustomer = new ListProductsByCustomerService_1.default(fakeProductsRepository);
                ...
                case 1:
                    product = _a.sent();
                    return [4 /*yield*/, listProductsByCustomer.execute(product.customer.id)];
                case 2:
