...
describe("UpdateProduct", function () {
    beforeEach(function () {
        ...
        updateProduct = new UpdateProductService_1.default(fakeProductsRepository, fakeStorageProvider);
    });
    ...
    it("should not be able to update a non existing product", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(updateProduct.execute({
    ...
    it("should not be able to change to a already used sku", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    product = _a.sent();
                    return [4 /*yield*/, expect(updateProduct.execute({
                            product_id: product.id,
                            customer_id: "fake-customer-id",
                            name: "Churrasqueira de controle remoto",
                            description: "Ta pegando fogo, bicho",
