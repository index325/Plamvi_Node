...
var ProductDetailService_1 = __importDefault(require("./ProductDetailService"));
...
describe("ProductDetail", function () {
    beforeEach(function () {
        ...
        showProductDetails = new ProductDetailService_1.default(fakeProductsRepository);
    });
    it("should be able to show details about a product", function () { return __awaiter(void 0, void 0, void 0, function () {
        var createProduct, product, productDetails;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    product = _a.sent();
                    return [4 /*yield*/, showProductDetails.execute(product.id)];
                case 2:
    ...
    it("should be able to show details about a product", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            expect(showProductDetails.execute("non-existing-product-id")).rejects.toBeInstanceOf(AppError_1.default);
            return [2 /*return*/];
        });
    }); });
});
