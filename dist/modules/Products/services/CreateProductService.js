...
var CreateProductService = /** @class */ (function () {
    function CreateProductService(productsRepository, storageProvider) {
        this.productsRepository = productsRepository;
        this.storageProvider = storageProvider;
    }
    CreateProductService.prototype.execute = function (_a) {
        var name = _a.name, sku = _a.sku, file = _a.file, customer_id = _a.customer_id, price = _a.price, description = _a.description, short_description = _a.short_description;
        return __awaiter(this, void 0, void 0, function () {
            var productAlreadyExists, image, product;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.productsRepository.verifyIfSKUAlreadyExistsWithoutId(sku)];
                    case 1:
