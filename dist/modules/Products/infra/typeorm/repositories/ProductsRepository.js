...
var ProductsRepository = /** @class */ (function () {
    ...
    ProductsRepository.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var product;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        product = this.ormRepository.create(data);
    ...
    ProductsRepository.prototype.update = function (data, product_id) {
        return __awaiter(this, void 0, void 0, function () {
            var product;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.ormRepository.update({ id: product_id }, data)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.ormRepository.findOne(product_id)];
                    case 2:
                        product = (_a.sent());
                        return [2 /*return*/, product];
                }
    ...
    ProductsRepository.prototype.findProductById = function (product_id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.ormRepository.findOne(product_id, { relations: ["customer"] })];
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.ormRepository.findOne({
                            where: { sku: sku, id: typeorm_1.Not(id) },
                        })];
                    case 1:
                        result = _b.sent();
